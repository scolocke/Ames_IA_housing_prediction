...
2. **IMPORTANT**: Click here: [Kaggle Competition](https://www.kaggle.com/c/deckard-dsi-p2/) to **join** the competition (otherwise you will not be able to make submissions!)
